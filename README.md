# CSV Data Summarizer with RAG

A small desktop GUI app to upload CSV files, preview data, generate basic statistics, create embeddings (via Ollama), and ask data-driven questions using retrieval-augmented generation (RAG).

## Features
- Upload and preview CSV files (first 20 rows)
...
4. In the UI: Upload a CSV → (optional - use for large files) Generate Embeddings → Ask questions or click Summarize
...
## Files
- `CSVSummarizer.py` — GUI and core logic
